 ...
 * @param {*} pid
 */
export function treeOrgDataTranslate (data, id = 'id', pid = 'parentId') {
  var res = []
  var temp = {}
  for (var i = 0; i < data.length; i++) {
    temp[data[i][id]] = data[i]
...
export function clearLoginInfo () {
  ...
  Vue.cookie.delete('orgId')
  Vue.cookie.delete('userType')
	Vue.cookie.delete('currentRoleName')
	Vue.cookie.delete('roleNameList')
	Vue.cookie.delete('roleIdList')
  localStorage.clear()
