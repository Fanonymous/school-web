<template>
	<div class="chart-box">
		...
		<div class="chart-box-img" v-if="xValue.length ==0">
			<!--<img src="~@/assets/img/charts/heatmap.png" width="100%" height="280px" />-->
	...
	export default {
		...
		methods: {
			initChart() {
				...
				myCharts = echarts.init(document.getElementById(this.id), 'macarons-screen')
				legendData = {
					show: this.isLegend,
					top: 10,
					left: 'right',
...
//				img.src=require('../../../assets/img/charts/heatmap.png')
...
//					},
			    ...
			    visualMap: {
			        ...
			        realtime: false,
			        inRange: {
			            color: ['#209742', '#45b46f', '#74d1b8', '#74d19b', '#e0f8ec', '#ffffbf', '#fee090', '#fdae61', '#f46d43', '#d73027', '#a50026']
			        }
			    },
			    series: [{
			        name: 'Gaussian',
