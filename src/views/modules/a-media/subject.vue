<template>
  <div class="mod-demo-echarts">
  	...
  	<media-analysis v-if="userType == 2" :gradeShow="gradeShow" @refreshChartsData="getFilterMediaData"></media-analysis>
  	<media-analysis v-if="userType == 4" :schoolTypeShow="gradeShow" :schoolSideTypeShow="gradeShow" :gradeShow="gradeShow" @refreshChartsData="getFilterMediaData"></media-analysis>
    ...
    <el-row :gutter="10">
      <el-col :span="24">
        <el-card>
          <chart-bar-line-zoom ref="sbarLineZoom" :id="'sbarLine'" :title="'学科使用对比'" :series="barLineSeries"></chart-bar-line-zoom>
        </el-card>
      </el-col>
      <el-col :span="24">
        <el-card>
          <chart-column ref="scolumnChart" :id="'scolumnChart'" :title="'学科使用深度对比'" :series="columnSeries"></chart-column>
        </el-card>
      </el-col>
    </el-row>
  </div>
...
//  },
    methods: {
    	...
    	resizeListener(){
    		if (this.$refs.sbarLineZoom.chart) {
	        this.$refs.sbarLineZoom.chart.resize()
	      }
	    	if (this.$refs.scolumnChart.chart) {
	        this.$refs.scolumnChart.chart.resize()
	      }
    	},
    	iniChartsData (){
      	let that = this;
