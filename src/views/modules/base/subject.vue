  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        let qtem = {limit:this.pagesize,order:"",page:this.currentPage,sidx:"",subName:""};
        if(this.schoolId !=0){
          qtem['schoolId']=this.schoolId;
        }
        var that = this
        getCommHttpData({url:'basedatacenter/subject/queryByCondition',method:'post',contentType:2,data:qtem},function(data){
          if(data.code == 0){
