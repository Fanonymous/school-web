				...
				<div class="first-step" style="position: relative;" :style="'height: '+appHeight+'px;overflow-y: auto;'">
					...
					<div v-show="isShowImport" :style="'height: '+appHeight+'px;overflow-y: auto;'">
						...
						<div class="course-item">
							...
							<div class="footer">
								<el-button @click="$router.push({name:'edu-master-schedule',params:{yearTermId:oldYearTermId,gradeId: oldGradeId,classId: oldClassId,termId:oldTermId,schoolYearId:oldSchoolYearId,className: oldClassName}})">取消录入</el-button>
	...
	export default {
		...
		methods: {
			...
			downloadTemplate(){
				...
				let getstr = '?excelType=xls&schoolId=' + this.schoolId + '&yearTermId=' + this.yearTermId + '&gradeId=' + this.gradeId +'&gradeName=' + this.gradeName+'&userId='+userId;
