...
;(function() {
  var resList = {
    ...
    css: [
      ...
      window.SITE_CONFIG.cdnUrl + '/static/plugins/ueditor-1.4.3.3/third-party/codemirror/codemirror.css',
    ],
    js: [
      // 插件, 放置业务之前加载, 以免业务需求依赖插件时, 还未加载出错
      // 插件 - echarts
      // window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/echarts.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/echarts.min1.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/echarts-liquidfill.min.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/echarts-wordcloud.min.js',

      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/macarons.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/echarts-3.8.5/macarons-diama.js',
      // 插件 - ueditor
      ...
      window.SITE_CONFIG.cdnUrl + '/static/plugins/ueditor-1.4.3.3/third-party/codemirror/codemirror.js',
      window.SITE_CONFIG.cdnUrl + '/static/plugins/ueditor-1.4.3.3/third-party/zeroclipboard/ZeroClipboard.js',
      // 业务
